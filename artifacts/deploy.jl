...
deploy_artifact(mpi_gpps_8D, "GPP_MPI_v006_2X_8D", "GPP", mpi_fold_8D, out_gpps_8D);
deploy_artifact(mpi_gpps_1M, "GPP_MPI_v006_2X_1M", "GPP", mpi_fold_1M, out_gpps_1M);
...
deploy_artifact(vpm_gpps_5X, "GPP_VPM_v20_5X_8D" , "GPP", vpm_fold_5X, out_gpps_5X);
deploy_artifact(vpm_gpps_12, "GPP_VPM_v20_12X_8D", "GPP", vpm_fold_12, out_gpps_12);
