...
"""
    request_LUT(artname::String, lat::Number, lon::Number, cyc::Int = 0; user::String="Anonymous", interpolation::Bool = false, server::String = "tropo.gps.caltech.edu", port::Int = 5055)
